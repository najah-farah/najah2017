<?php
	...
	if(isset($_POST["upload"]))
	{
		...
		if(!isset($error)){
		if(mysqli_query($connection, "INSERT INTO `photos`(`category`, `photosName`, `image`, `price`, `photographerId`) VALUES('" . ucwords(strtolower(trim($_POST["category"]))) . "', '" . ucwords(strtolower(trim($_POST["photosName"]))) . "', '$fileName1', '" . trim($_POST["price"]) . "', '" . $_SESSION["photographerId"] . "')"))
		{
